...
main(int argc, char *argv[])
{
  ...
  18:	21413023          	sd	s4,512(sp)
  1c:	1c00                	addi	s0,sp,560
  if(argc == 1){
  1e:	4785                	li	a5,1
  20:	00f50e63          	beq	a0,a5,3c <main+0x3c>
    printf("Example 4:\n");
  ...
  24:	4789                	li	a5,2
  26:	08f50863          	beq	a0,a5,b6 <main+0xb6>
        break;
      n += nn;
    }
    memdump(argv[1], data);
  ...
  2e:	9e650513          	addi	a0,a0,-1562 # a10 <malloc+0x152>
  32:	7d4000ef          	jal	806 <printf>
    exit(1);
  36:	4505                	li	a0,1
  38:	382000ef          	jal	3ba <exit>
    printf("Example 1:\n");
  3c:	00001517          	auipc	a0,0x1
  40:	97450513          	addi	a0,a0,-1676 # 9b0 <malloc+0xf2>
  44:	7c2000ef          	jal	806 <printf>
    printf("Example 2:\n");
  48:	00001517          	auipc	a0,0x1
  4c:	97850513          	addi	a0,a0,-1672 # 9c0 <malloc+0x102>
  50:	7b6000ef          	jal	806 <printf>
    printf("Example 3:\n");
  54:	00001517          	auipc	a0,0x1
  58:	97c50513          	addi	a0,a0,-1668 # 9d0 <malloc+0x112>
  5c:	7aa000ef          	jal	806 <printf>
    example.ptr = "hello";
  60:	00001797          	auipc	a5,0x1
  64:	98078793          	addi	a5,a5,-1664 # 9e0 <malloc+0x122>
  68:	dcf43823          	sd	a5,-560(s0)
    example.num1 = 1819438967;
  6c:	6c7277b7          	lui	a5,0x6c727
  70:	f7778793          	addi	a5,a5,-137 # 6c726f77 <base+0x6c725f67>
  74:	dcf42c23          	sw	a5,-552(s0)
    example.num2 = 100;
  78:	06400793          	li	a5,100
  7c:	dcf41e23          	sh	a5,-548(s0)
    example.byte = 'z';
  80:	07a00793          	li	a5,122
  84:	dcf40f23          	sb	a5,-546(s0)
    strcpy(example.bytes, "xyzzy");
  88:	00001597          	auipc	a1,0x1
  8c:	96058593          	addi	a1,a1,-1696 # 9e8 <malloc+0x12a>
  90:	ddf40513          	addi	a0,s0,-545
  94:	080000ef          	jal	114 <strcpy>
    printf("Example 4:\n");
  98:	00001517          	auipc	a0,0x1
  9c:	95850513          	addi	a0,a0,-1704 # 9f0 <malloc+0x132>
  a0:	766000ef          	jal	806 <printf>
    printf("Example 5:\n");
  a4:	00001517          	auipc	a0,0x1
  a8:	95c50513          	addi	a0,a0,-1700 # a00 <malloc+0x142>
  ac:	75a000ef          	jal	806 <printf>
  }
  exit(0);
  b0:	4501                	li	a0,0
  b2:	308000ef          	jal	3ba <exit>
    memset(data, '\0', sizeof(data));
  b6:	20000613          	li	a2,512
  ba:	4581                	li	a1,0
  bc:	dd040513          	addi	a0,s0,-560
  c0:	0d0000ef          	jal	190 <memset>
    int n = 0;
  c4:	4481                	li	s1,0
    while(n < sizeof(data)){
  c6:	4601                	li	a2,0
      int nn = read(0, data + n, sizeof(data) - n);
  c8:	20000993          	li	s3,512
  cc:	dd040913          	addi	s2,s0,-560
    while(n < sizeof(data)){
  d0:	1ff00a13          	li	s4,511
      int nn = read(0, data + n, sizeof(data) - n);
  d4:	40c9863b          	subw	a2,s3,a2
  d8:	009905b3          	add	a1,s2,s1
  dc:	4501                	li	a0,0
  de:	2f4000ef          	jal	3d2 <read>
      if(nn <= 0)
  e2:	fca057e3          	blez	a0,b0 <main+0xb0>
      n += nn;
  e6:	0095063b          	addw	a2,a0,s1
  ea:	84b2                	mv	s1,a2
    while(n < sizeof(data)){
  ec:	feca74e3          	bgeu	s4,a2,d4 <main+0xd4>
  f0:	b7c1                	j	b0 <main+0xb0>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 49e:	59e80813          	addi	a6,a6,1438 # a38 <digits>
 4a2:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c8:	374b8b93          	addi	s7,s7,884 # a38 <digits>
 ...
 726:	30e48493          	addi	s1,s1,782 # a30 <malloc+0x172>
        for(; *s; s++)
